(function() {
  var Access, Arr, As, Assign, Base, Block, Call, Class, Closure, Code, Comment, Existence, Extends, For, IDENTIFIER, IDENTIFIER_STR, IS_STRING, If, In, Index, Isa, LEVEL_ACCESS, LEVEL_COND, LEVEL_LIST, LEVEL_OP, LEVEL_PAREN, LEVEL_TOP, Let, Literal, METHOD_DEF, NEGATE, NO, Obj, Op, Overload, Param, Parens, RESERVED, Range, Return, SIMPLENUM, Scope, Slice, Splat, Switch, TAB, THIS, Throw, Try, TypedFunction, TypedParam, UTILITIES, Value, While, YES, compact, del, ends, extend, flatten, last, merge, multident, starts, unfoldSoak, utility, _ref;
  ...
  exports.Value = Value = (function() {
    ...
    Value.prototype.getLastProperty = function() {
  ...
  exports.Call = Call = (function() {
    ...
    Call.prototype.compileNode = function(o) {
      ...
      if (this.isSuper) {
        ...
        if (this.isNew) {
          return "" + (utility('new')) + ".call(" + (this.variable.compile(o, LEVEL_ACCESS)) + (args.length === 0 ? '' : ', ') + args + ")";
        } else {
    ...
    Call.prototype.compileSplat = function(o, splatArgs) {
      ...
      if (this.isNew) {
        idt = this.tab + TAB;
        return "(function(func, args) {\n" + idt + "return " + (utility('new')) + ".apply(func, args);\n" + this.tab + "})(" + (this.variable.compile(o, LEVEL_LIST)) + ", " + splatArgs + ")";
  ...
  exports.Assign = Assign = (function() {
    ...
    Assign.prototype.compileNode = function(o) {
      var match, name, val, varBase, _ref2, _ref3, _ref4, _ref5;
  ...
  exports.Overload = Overload = (function() {
    __extends(Overload, Base);
    function Overload(functions) {
      this.functions = functions;
    }
    Overload.prototype.children = ['functions'];
    Overload.prototype.compileNode = function(o) {
      var code, func;
      o.scope = new Scope(o.scope, this.body, this);
      o.scope.shared = del(o, 'sharedScope');
      o.indent += TAB;
      code = ((function() {
        ...
        for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
          func = _ref2[_i];
          _results.push(func.compile(o));
        }
        return _results;
      }).call(this)).join('');
      code += "" + o.indent + "throw 'Unsupported argument list';\n";
      return "(function(_this) { return function() {\n" + code + this.tab + "} })(this)";
    };
    return Overload;
  })();
  exports.TypedFunction = TypedFunction = (function() {
    __extends(TypedFunction, Base);
    function TypedFunction(params, body, tag) {
      this.tag = tag;
      this.params = params || [];
      this.body = body || new Block;
    }
    TypedFunction.prototype.children = ['params', 'body'];
    TypedFunction.prototype.isStatement = function() {
      return !!this.ctor;
    };
    TypedFunction.prototype.jumps = NO;
    TypedFunction.prototype.compileNode = function(o) {
      var backingFunc, code, context, newParamList, param, pattern;
      pattern = ((function() {
        var _i, _len, _ref2, _results;
        _ref2 = this.params;
        _results = [];
        for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
          param = _ref2[_i];
          _results.push(param.type.compile(o));
        }
        return _results;
      }).call(this)).join(', ');
      pattern = "[" + pattern + "]";
      newParamList = (function() {
        var _i, _len, _ref2, _results;
        _ref2 = this.params;
        _results = [];
        for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
          param = _ref2[_i];
          _results.push(new Param(param.name));
        }
        return _results;
      }).call(this);
      backingFunc = new Code(newParamList, this.body, 'func');
      code = "" + o.indent + "if(" + (utility('matches')) + "(arguments, " + pattern + "))\n";
      o.indent += TAB;
      context = this.tag === 'boundfunc' ? '_this' : 'this';
      return code += "" + o.indent + "return (" + (backingFunc.compile(o)) + ").apply(" + context + ", arguments);\n";
    };
    TypedFunction.prototype.traverseChildren = function(crossScope, func) {
      if (crossScope) {
        return TypedFunction.__super__.traverseChildren.call(this, crossScope, func);
      }
    };
    return TypedFunction;
  })();
  exports.TypedParam = TypedParam = (function() {
    __extends(TypedParam, Base);
    function TypedParam(type, name) {
      this.type = type;
      this.name = name;
    }
    TypedParam.prototype.children = ['type', 'name'];
    TypedParam.prototype.compile = function(o) {
      return this.name.compile(o, LEVEL_LIST);
    };
    TypedParam.prototype.isComplex = NO;
    return TypedParam;
  })();
  ...
  exports.Op = Op = (function() {
    ...
    function Op(op, first, second, flip) {
      ...
      if (op === 'isa') {
        return new Isa(first, second);
      }
      if (op === 'as') {
        return new As(first, second);
      }
      if (op === 'do') {
    ...
    Op.prototype.compileUnary = function(o) {
      ...
      if (this.operator === 'new') {
        return "" + (utility('new')) + ".call(" + (this.first.compile(o, LEVEL_OP)) + ")";
      }
  ...
  exports.Isa = Isa = (function() {
    __extends(Isa, Base);
    function Isa(child, parent) {
      this.child = child;
      this.parent = parent;
    }
    Isa.prototype.children = ['object', 'object'];
    Isa.prototype.invert = NEGATE;
    Isa.prototype.compileNode = function(o) {
      var code;
      code = utility('isa') + ("(" + (this.child.compile(o, LEVEL_LIST)) + ", " + (this.parent.compile(o, LEVEL_LIST)) + ")");
      if (this.negated) {
        return "!" + code;
      } else {
        return code;
    ...
    Isa.prototype.toString = function(idt) {
      return Isa.__super__.toString.call(this, idt, this.constructor.name + (this.negated ? '!' : ''));
    };
    return Isa;
  })();
  exports.As = As = (function() {
    __extends(As, Base);
    function As(_function, object) {
      this["function"] = _function;
      this.object = object;
    }
    As.prototype.children = ['function', 'object'];
    As.prototype.compileNode = function(o) {
      return "" + (utility('bind')) + "(" + (this["function"].compile(o, LEVEL_LIST)) + ", " + (this.object.compile(o, LEVEL_LIST)) + ")";
    };
    As.prototype.toString = function(idt) {
      return As.__super__.toString.call(this, idt, this.constructor.name);
    };
    return As;
  })();
  ...
  exports.Let = Let = (function() {
    __extends(Let, Base);
    function Let(params, body, options) {
      this.params = params;
      this.body = body;
    }
    Let.prototype.children = ['params', 'body'];
    Let.prototype.bodyNode = function() {
      var _ref2;
      return (_ref2 = this.body) != null ? _ref2.unwrap() : void 0;
    };
    Let.prototype.isStatement = function(o) {
      return (o != null ? o.level : void 0) === LEVEL_TOP || this.bodyNode().isStatement(o);
    };
    Let.prototype.jumps = function(o) {
      var _ref2;
      return this.body.jumps(o) || ((_ref2 = this.elseBody) != null ? _ref2.jumps(o) : void 0);
    };
    Let.prototype.makeReturn = function(res) {
      this.body && (this.body = new Block([this.body.makeReturn(res)]));
      return this;
    };
    Let.prototype.ensureBlock = function(node) {
      if (node instanceof Block) {
        return node;
      } else {
        return new Block([node]);
    ...
    Let.prototype.jumps = function(o) {
      return this.body.jumps(o);
    };
    Let.prototype.compileNode = function(o) {
      var body, bodyc, code, param, paramNames, paramValues;
      paramNames = ((function() {
        var _i, _len, _ref2, _results;
        _ref2 = this.params;
        _results = [];
        for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
          param = _ref2[_i];
          _results.push(param.name.compile(o, LEVEL_LIST));
        }
        return _results;
      }).call(this)).join(', ');
      paramValues = ((function() {
        ...
        for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
          param = _ref2[_i];
          _results.push(((_ref3 = param.value) != null ? _ref3 : param.name).compile(o, LEVEL_LIST));
        }
        return _results;
      }).call(this)).join(', ');
      o.indent += TAB;
      ...
      if ((o != null ? o.level : void 0) === LEVEL_TOP) {
        code = "" + this.tab + code + ";";
      }
      return code;
    };

(function() {
  var Access, Arr, As, Assign, Base, Block, Call, Class, Closure, Code, Comment, Existence, Extends, For, IDENTIFIER, IDENTIFIER_STR, IS_STRING, If, In, Index, Isa, LEVEL_ACCESS, LEVEL_COND, LEVEL_LIST, LEVEL_OP, LEVEL_PAREN, LEVEL_TOP, Literal, METHOD_DEF, NEGATE, NO, Obj, Op, Param, Parens, RESERVED, Range, Return, SIMPLENUM, Scope, Slice, Splat, Switch, TAB, THIS, Throw, Try, UTILITIES, Value, While, YES, compact, del, ends, extend, flatten, last, merge, multident, starts, unfoldSoak, utility, _ref;
  ...
  exports.Op = Op = (function() {
    ...
    function Op(op, first, second, flip) {
      var args, call, param, params, _i, _len, _ref2;
      if (op === 'in') {
      ...
      if (op === 'do' || op === 'let') {
        params = (_ref2 = first.params) != null ? _ref2 : [];
        args = (function() {
          var _i, _len, _ref3, _results;
          _results = [];
          for (_i = 0, _len = params.length; _i < _len; _i++) {
            param = params[_i];
            _results.push((_ref3 = param.value) != null ? _ref3 : param);
          }
          return _results;
        })();
        for (_i = 0, _len = params.length; _i < _len; _i++) {

(function() {
  ...
  exports.Rewriter = (function() {
    ...
    Rewriter.prototype.addImplicitParentheses = function() {
      ...
      return this.scanTokens(function(token, i, tokens) {
        var callObject, current, isParamDefinition, next, prev, seenControl, seenSingle, tag, _ref, _ref2, _ref3;
        tag = token[0];
        if (tag === 'CLASS' || tag === 'IF') {
          noCall = true;
        }
        _ref = tokens.slice(i - 1, (i + 1 + 1) || 9e9), prev = _ref[0], current = _ref[1], next = _ref[2];
        isParamDefinition = (function() {
          var token, _i, _len, _ref2;
          _ref2 = tokens.slice(0, i).reverse();

(function() {
  ...
  JS_KEYWORDS = ['true', 'false', 'null', 'this', 'new', 'delete', 'typeof', 'in', 'instanceof', 'return', 'throw', 'break', 'continue', 'debugger', 'if', 'else', 'switch', 'for', 'while', 'do', 'try', 'catch', 'finally', 'class', 'extends', 'super', 'let', 'function'];
  COFFEE_KEYWORDS = ['undefined', 'then', 'unless', 'until', 'loop', 'of', 'by', 'when', 'isa', 'as', 'over'];
  COFFEE_ALIAS_MAP = {
    and: '&&',
    or: '||',
    is: '==',
  ...
  RESERVED = ['case', 'default', 'var', 'void', 'with', 'const', 'enum', 'export', 'import', 'native', '__hasProp', '__extends', '__slice', '__bind', '__indexOf', '__isa', '__new'];
